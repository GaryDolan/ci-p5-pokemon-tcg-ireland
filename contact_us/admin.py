"""
Admin configurations for the contact_us app
"""
...
class ContactAdmin(SummernoteModelAdmin):
    """
    Customises the django admin interface for the contact model
    """
    list_display = [
        'name',
        'email',
    ...
    def mark_as_replied(self, request, queryset):
        ...
        self.message_user(
            request,
            'Selected contacts have been marked as replied.'
        )
    ...
    def mark_as_not_replied(self, request, queryset):
        ...
        self.message_user(
            request,
            'Selected contacts have been marked as not replied too.'
        )
    ...
    def mark_as_resolved(self, request, queryset):
        ...
        self.message_user(
            request,
            'Selected contacts have been marked as resolved.'
        )
    ...
    def mark_as_not_resolved(self, request, queryset):
        ...
        self.message_user(
            request,
            'Selected contacts have been marked as not resolved.'
        )
