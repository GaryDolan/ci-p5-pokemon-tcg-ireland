...
# DEVELOPMENT environ controls Debug. Local=TRUE, remote=FALSE.
...
STANDARD_SHIPPING_COST = Decimal('7.99')

# Amazon Web Services
# only use on heroku so add the USE_AWS to config vars
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'pokemon-tcg-ireland-bucket'
